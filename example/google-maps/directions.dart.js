...
$$.JsIsolateSink = {"": "StreamSink;_isClosed,_liblib0$_port<",
  add$1: function(_, message) {
    $.send$1$x(this._liblib0$_port, message);
  },
  $eq: function(_, other) {
    if (other == null)
      return false;
    return typeof other === "object" && other !== null && !!$.getInterceptor(other).$isIsolateSink && $.$eq(this._liblib0$_port, other.get$_liblib0$_port()) === true;
  },
...
$$._NativeJsSendPort = {"": "_BaseSendPort;_liblib0$_receivePort<,_isolateId",
  ...
  $eq: function(_, other) {
    if (other == null)
      return false;
    return typeof other === "object" && other !== null && !!$.getInterceptor(other).$is_NativeJsSendPort && $.$eq(this._liblib0$_receivePort, other._liblib0$_receivePort) === true;
  },
  get$hashCode: function(_) {
    return this._liblib0$_receivePort.get$_liblib0$_id();
  },
...
$$._NativeJsSendPort_send_anon = {"": "Closure;this_1,message_2,replyTo_3",
  call$0: function() {
    ...
    if (isolate == null)
      return;
    if (t2.get$_liblib0$_receivePort().get$_liblib0$_callback() == null)
      return;
...
$$._NativeJsSendPort_send__anon = {"": "Closure;box_0,this_4,shouldSerialize_5",
  call$0: function() {
    var t1, t2;
    t1 = this.this_4;
    if (t1.get$_liblib0$_receivePort().get$_liblib0$_callback() != null) {
...
$$.ReceivePortImpl = {"": "Object;_liblib0$_id<,_liblib0$_callback<",
  ...
  close$0: function(_) {
    ...
    $globalState.currentContext.unregister$1(this._liblib0$_id);
  },
  toSendPort$0: function() {
    return $._NativeJsSendPort$(this, $.get$id$x($globalState.currentContext));
  },
  ReceivePortImpl$0: function() {
    $._globalState().get$currentContext().register$2(this._liblib0$_id, this);
  }
};
...
$$._JsSerializer = {"": "_Serializer;_nextFreeRefId,_visited",
  visitSendPort$1: function(x) {
    if (typeof x === "object" && x !== null && !!$.getInterceptor(x).$is_NativeJsSendPort)
      return ["sendport", $globalState.currentManagerId, x._isolateId, x._liblib0$_receivePort.get$_liblib0$_id()];
...
$$._JsCopier = {"": "_Copier;_visited",
  ...
  visitIsolateSink$1: function(sink) {
    ...
    result = $.JsIsolateSink$fromPort(this.visitSendPort$1(sink._liblib0$_port));
...
$$._JsDeserializer = {"": "_Deserializer;_liblib0$_deserialized",
...
$$._Deserializer = {"": "Object;",
  ...
  _liblib0$_deserializeMap$1$bailout: function(state0, x, result, keys, t1, values, t3, len) {
    switch (state0) {
      case 0:
        result = $.HashMap$();
        t1 = $.getInterceptor$asx(x);
...
$$.Object = {"": ";",
  ...
  get$controls: function($receiver) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("controls", "get$controls", 1, [], []));
  },
  ...
  setDirections$1: function($0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("setDirections", "setDirections$1", 0, [$0], []));
  },
  setPanel$1: function($0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("setPanel", "setPanel$1", 0, [$0], []));
  },
...
$$._ChildrenElementList = {"": "Object;_element,_childElements",
  ...
  skip$1: function(_, n) {
    return $.SubListIterable$(this, n, null);
  },
  elementAt$1: function(_, index) {
...
$$._JsDeserializer0 = {"": "_Deserializer0;_deserialized",
...
$$._JsSendPortSync = {"": "Object;_liblib2$_id",
  callSync$1: function(message) {
    var result = ReceivePortSync.dispatchCall(this._liblib2$_id, $._JsSerializer$().traverse$1(message));
...
$$.calcRoute_anon = {"": "Closure;",
  call$2: function(response, $status) {
    if ($.$eq($status, $.maps.get$DirectionsStatus().get$OK()) === true) {
      $.set$innerHtml$x(document.querySelector("#directions_panel"), "");
      $.directionsDisplay.setDirections$1(response);
    } else
      $.set$innerHtml$x(document.querySelector("#directions_panel"), "<b>Err, try flying.</b>");
  }
};
...
$$.Callback = {"": "Object;_manualDispose,_id<,_liblib4$_callback",
  _initialize$1: function(manualDispose) {
    this._manualDispose = manualDispose;
    this._id = $.add$1$ax($.get$_proxiedObjectTable(), this._liblib4$_callback);
  ...
  Callback$once$2$withThis: function(f, withThis) {
    this._liblib4$_callback = new $.anon0(this, f, withThis);
...
$$.anon0 = {"": "Closure;this_0,f_1,withThis_2",
  call$1: function(args) {
    var t1, t2;
    try {
      t1 = this.f_1;
      t2 = this.withThis_2 ? args : $.toList$0$ax($.skip$1$ax(args, 1));
      t2 = $.Primitives_applyFunction(t1, t2, null);
      return t2;
    } finally {
...
$$.MediaElement = {"": "Element;controls=,error="};
...
$.main = function() {
  var t1, myOptions, map, t2, control;
  $._enterScopeIfNeeded();
  t1 = $._deserialize($._jsPortSync.callSync$1([])).get$google().get$maps();
  $._jsGlobalize.callSync$1($._serialize(t1.toJs$0()));
  $.maps = t1;
  t1 = $.maps;
  t1 = $.makeLiteralMap(["zoom", 9, "mapTypeId", t1.get$MapTypeId().get$ROADMAP(), "center", $.Proxy_Proxy$withArgList(t1.get$LatLng(), $._pruneUndefined(47.6097, -122.3331, $.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined))]);
  $._enterScopeIfNeeded();
  myOptions = $._deserialize($._jsPortConvert.callSync$1($.Proxy__serializeDataTree(t1)));
  map = $.Proxy_Proxy$withArgList($.maps.get$Map(), $._pruneUndefined(document.querySelector("#map_canvas"), myOptions, $.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined));
  t1 = $.maps.get$DirectionsRenderer();
  t2 = $.makeLiteralMap(["map", map]);
  $._enterScopeIfNeeded();
  t2 = $.Proxy_Proxy$withArgList(t1, $._pruneUndefined($._deserialize($._jsPortConvert.callSync$1($.Proxy__serializeDataTree(t2))), $.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined));
  $._jsGlobalize.callSync$1($._serialize(t2.toJs$0()));
  $.directionsDisplay = t2;
  $.directionsDisplay.setPanel$1(document.querySelector("#directions_panel"));
  t2 = $.Proxy_Proxy$withArgList($.maps.get$DirectionsService(), $._pruneUndefined($.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined));
  $._jsGlobalize.callSync$1($._serialize(t2.toJs$0()));
  $.directionsService = t2;
  control = document.querySelector("#control");
  $.set$display$x(control.style, "block");
  $.$index$asx($.get$controls$x(map), $.maps.get$ControlPosition().get$TOP()).push$1(control);
  $.get$onChange$x(document.querySelector("#start")).listen$1($.calcRoute);
  $.get$onChange$x(document.querySelector("#end")).listen$1($.calcRoute);
};

$.calcRoute = function(e) {
  var panel, start, end, t1, request;
  panel = document.querySelector("#directions_panel");
  start = document.querySelector("#start");
  end = document.querySelector("#end");
  $.set$innerHtml$x(panel, "<b>Thinking...</b>");
  t1 = $.makeLiteralMap(["origin", $.get$value$x(start), "destination", $.get$value$x(end), "travelMode", $.maps.get$DirectionsTravelMode().get$DRIVING()]);
  $._enterScopeIfNeeded();
  request = $._deserialize($._jsPortConvert.callSync$1($.Proxy__serializeDataTree(t1)));
  $.directionsService.route$2(request, $.Callback$once(new $.calcRoute_anon(), false));
};
...
$.get$controls$x = function(receiver) {
  return $.getInterceptor$x(receiver).get$controls(receiver);
};
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,eval$1,get$OK,get$sb,push$1,then$1,toJs$0,get$Map,get$TOP,get$_id,route$2,get$_tag,get$maps,lookup$1,toJson$0,get$cause,process$0,_writeOn$1,callSync$1,get$LatLng,get$_state,get$google,moveNext$0,register$2,set$_state,_callback$1,_dispatch$1,_sendData$1,exitScope$0,get$DRIVING,get$ROADMAP,get$current,set$_handle,_sendError$1,_sendValue$1,catchError$1,enterScope$0,get$isWorker,get$sendPort,invalidate$1,toSendPort$0,unregister$1,_setGlobals$0,get$MapTypeId,get$_duration,get$_registry,get$_workerId,get$_hashTable,get$_isolateId,get$stackTrace,runIteration$0,throwDelayed$0,_checkReplyTo$1,get$_futurePort,get$_liblib0$_id,get$topEventLoop,get$_liblib5$_set,get$_nextListener,get$_scopeIndices,get$nextIsolateId,set$_nextListener,set$nextIsolateId,get$currentContext,get$ControlPosition,_liblib0$_callback$2,get$DirectionsStatus,get$DirectionsService,get$DirectionsRenderer,get$_hasUnhandledError,get$_liblib0$_callback,get$_resultOrListeners,get$DirectionsTravelMode,get$_liblib0$_receivePort".split(","), longNames = "call,call,call,call,call,eval,OK,sb,push,then,toJs,Map,TOP,_id,route,_tag,maps,lookup,toJson,cause,process,_writeOn,callSync,LatLng,_state,google,moveNext,register,_state=,_callback,_dispatch,_sendData,exitScope,DRIVING,ROADMAP,current,_handle=,_sendError,_sendValue,catchError,enterScope,isWorker,sendPort,invalidate,toSendPort,unregister,_setGlobals,MapTypeId,_duration,_registry,_workerId,_hashTable,_isolateId,stackTrace,runIteration,throwDelayed,_checkReplyTo,_futurePort,_id,topEventLoop,_set,_nextListener,_scopeIndices,nextIsolateId,_nextListener=,nextIsolateId=,currentContext,ControlPosition,_callback,DirectionsStatus,DirectionsService,DirectionsRenderer,_hasUnhandledError,_callback,_resultOrListeners,DirectionsTravelMode,_receivePort".split(",");
