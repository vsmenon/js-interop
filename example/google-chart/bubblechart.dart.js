...
$$._JsSerializer = {"": "_Serializer;_nextFreeRefId,_visited",
  visitSendPort$1: function(x) {
    if (typeof x === "object" && x !== null && !!$.getInterceptor(x).$is_NativeJsSendPort)
      return ["sendport", $globalState.currentManagerId, x._isolateId, x._receivePort.get$_liblib2$_id()];
...
$$.HashSet = {"": "Collection;_liblib0$_length,_strings,_nums,_rest,_elements",
  get$iterator: function(_) {
...
$$.Object = {"": ";",
  ...
  setOnLoadCallback$1: function($0) {
    return this.noSuchMethod$1(this, $.createInvocationMirror("setOnLoadCallback", "setOnLoadCallback$1", 0, [$0], []));
  },
...
$$.main_drawVisualization = {"": "Closure;",
  call$1: function(_) {
    var google, t1, data, options;
    $._enterScopeIfNeeded();
    google = $._deserialize($._jsPortSync.callSync$1([])).get$google();
    t1 = google.get$visualization();
    $._enterScopeIfNeeded();
    data = t1.arrayToDataTable$1($._deserialize($._jsPortConvert.callSync$1($.Proxy__serializeDataTree([["ID", "Life Expectancy", "Fertility Rate", "Region", "Population"], ["CAN", 80.66, 1.67, "North America", 33739900], ["DEU", 79.84, 1.36, "Europe", 81902307], ["DNK", 78.6, 1.84, "Europe", 5523095], ["EGY", 72.73, 2.78, "Middle East", 79716203], ["GBR", 80.05, 2, "Europe", 61801570], ["IRN", 72.49, 1.7, "Middle East", 73137148], ["IRQ", 68.09, 4.77, "Middle East", 31090763], ["ISR", 81.55, 2.96, "Middle East", 7485600], ["RUS", 68.6, 1.54, "Europe", 141850000], ["USA", 78.09, 2.05, "North America", 307007000]]))));
    t1 = $.makeLiteralMap(["title", "Correlation between life expectancy, fertility rate and population of some world countries (2010)", "hAxis", $.makeLiteralMap(["title", "Life Expectancy"]), "vAxis", $.makeLiteralMap(["title", "Fertility Rate"]), "bubble", $.makeLiteralMap(["textStyle", $.makeLiteralMap(["fontSize", 11])])]);
    $._enterScopeIfNeeded();
    options = $._deserialize($._jsPortConvert.callSync$1($.Proxy__serializeDataTree(t1)));
    $.Proxy_Proxy$withArgList(google.get$visualization().get$BubbleChart(), $._pruneUndefined(document.querySelector("#visualization"), $.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined, $.C__Undefined)).draw$2(data, options);
  }
};
...
$$.Callback = {"": "Object;_manualDispose,_id<,_callback",
  _initialize$1: function(manualDispose) {
    ...
    this._id = $.add$1$ax($.get$_proxiedObjectTable(), this._callback);
  ...
  Callback$once$2$withThis: function(f, withThis) {
    this._callback = new $.anon(this, f, withThis);
...
$$.anon = {"": "Closure;this_0,f_1,withThis_2",
  call$1: function(args) {
    var t1, t2;
    try {
      t1 = this.f_1;
...
$.main = function() {
  var t1 = new $.main_drawVisualization();
  $._enterScopeIfNeeded();
  $._deserialize($._jsPortSync.callSync$1([])).get$google().setOnLoadCallback$1($.Callback$once(t1, false));
};
...
function init() {
  ...
  Isolate.$finishClasses = function(collectedClasses, isolateProperties, existingIsolateProperties) {
    ...
    var objectClassObject = collectedClasses.Object, shortNames = "call$0,call$1,call$2,call$3,call$4,draw$2,eval$1,get$sb,then$1,get$_id,get$_tag,lookup$1,toJson$0,get$cause,process$0,_writeOn$1,callSync$1,get$_state,get$google,moveNext$0,register$2,set$_state,_dispatch$1,_sendData$1,exitScope$0,get$current,set$_handle,_sendError$1,_sendValue$1,catchError$1,enterScope$0,get$isWorker,get$sendPort,invalidate$1,toSendPort$0,unregister$1,_setGlobals$0,get$_duration,get$_registry,get$_workerId,get$_hashTable,get$_isolateId,get$stackTrace,runIteration$0,throwDelayed$0,_checkReplyTo$1,get$BubbleChart,get$_futurePort,get$_liblib2$_id,get$_receivePort,get$topEventLoop,get$_liblib5$_set,get$_nextListener,get$_scopeIndices,get$nextIsolateId,get$visualization,set$_nextListener,set$nextIsolateId,arrayToDataTable$1,get$currentContext,_liblib1$_callback$1,_liblib2$_callback$2,get$_hasUnhandledError,get$_liblib2$_callback,get$_resultOrListeners".split(","), longNames = "call,call,call,call,call,draw,eval,sb,then,_id,_tag,lookup,toJson,cause,process,_writeOn,callSync,_state,google,moveNext,register,_state=,_dispatch,_sendData,exitScope,current,_handle=,_sendError,_sendValue,catchError,enterScope,isWorker,sendPort,invalidate,toSendPort,unregister,_setGlobals,_duration,_registry,_workerId,_hashTable,_isolateId,stackTrace,runIteration,throwDelayed,_checkReplyTo,BubbleChart,_futurePort,_id,_receivePort,topEventLoop,_set,_nextListener,_scopeIndices,nextIsolateId,visualization,_nextListener=,nextIsolateId=,arrayToDataTable,currentContext,_callback,_callback,_hasUnhandledError,_callback,_resultOrListeners".split(",");
